<x-layout title="Data ASTAP - SIMAT-RK" :fullWidth="true">
    ...
    <div x-data="astapCatalog()" x-cloak class="space-y-6">
        ...
        @include('pages.astap.index_partials.header_banner')

        <!-- 3. Filter Bar (KIB, Tahun, Triwulan, Search & Tombol Ekspor) -->
        @include('pages.astap.index_partials.filter_bar')

        <!-- 4. Tabel Katalog Data ASTAP Utama -->
        @include('pages.astap.index_partials.table')
        ...
        @include('pages.astap.index_partials.modal_qr')
        ...
        @include('pages.astap.index_partials.modal_export_excel')

        <!-- 9. Modal Dialog: Rapikan & Urutkan Ulang NIBAR -->
        @include('pages.astap.index_partials.modal_resequence_nibar')
