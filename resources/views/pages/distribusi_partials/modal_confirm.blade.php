            ...
            <div @click.away="showConfirmModal = false"
                ...
                <template x-if="confirmData.showReasonInput">
                    <div class="space-y-1.5">
                        <label class="text-[10px] uppercase font-bold text-slate-400 block tracking-wider">Alasan Penolakan (Opsional):</label>
                        <input type="text" x-model="alasanTolak" placeholder="Contoh: Stok barang di gudang kosong / salah unit..."
                            class="w-full bg-slate-950 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-rose-500 transition-all">
                    </div>
                </template>
