                ...
                <template x-if="isJaringan">
                    <div class="space-y-6">
                        ...
                        <div x-show="formData.is_extracomtable" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between px-4 py-3 rounded-2xl bg-cyan-950/30 border border-cyan-500/40">
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <div>
                                        <p class="text-xs font-black text-cyan-300">Mode: Barang Ekstrakomtabel (Extracom) — KIB D Jalan, Irigasi & Jaringan</p>
                        ...
                        <!-- MODE REGULER: FORM JARINGAN ASLI -->
                        <div x-show="!formData.is_extracomtable" class="space-y-6">
                                ...
                                <template x-for="(item, idx) in formData.jaringan_items" :key="idx">
                                    <div class="p-5 sm:p-6 rounded-3xl bg-slate-950/90 border border-teal-500/30 hover:border-teal-500/60 transition-all space-y-4 shadow-xl relative group">
                                        ...
                                        <div class="p-4 rounded-2xl bg-slate-900/80 border border-teal-500/30 space-y-2.5">
                                            ...
                                            <div :class="getJaringanSubtotal(item) > 0 && getJaringanSubtotal(item) < 300000 ? 'border-rose-500/60 bg-rose-950/20' : 'border-slate-800 bg-slate-950/60'" 
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <span :class="getJaringanSubtotal(item) > 0 && getJaringanSubtotal(item) < 300000 ? 'text-rose-400' : 'text-teal-400'" 
                                                          class="text-xs font-black font-mono" x-text="'Rp ' + formatRupiah(getJaringanSubtotal(item))"></span>
                                                </div>
                                                <span x-show="getJaringanSubtotal(item) > 0 && getJaringanSubtotal(item) < 300000" class="text-[10px] font-bold text-rose-400">
