<!-- ========================================================================= -->
<!-- GLOBAL FLOATING NOTIFICATION TOAST (KEMITRAAN PIHAK KETIGA 1.5.2)         -->
<!-- ========================================================================= -->
<div x-show="toast.show" 
     ...
     :class="{
         ...
         'bg-cyan-950/90 border-cyan-500/50 text-cyan-100 shadow-cyan-950/50': toast.type === 'info'
     }"
     x-cloak>
    <div class="text-xl shrink-0 mt-0.5" x-text="toast.type === 'success' ? '🎉' : (toast.type === 'warning' ? '⚠️' : (toast.type === 'info' ? 'ℹ️' : '❌'))"></div>
    ...
    <button type="button" @click="toast.show = false" class="text-slate-400 hover:text-white shrink-0 p-1 cursor-pointer">
        ✕
    </button>
</div>
