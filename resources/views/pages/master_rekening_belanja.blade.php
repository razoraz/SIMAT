<x-layout title="Rekening Belanja SIPD - SIMAT-RK">
    ...
    <div x-data="{
        ...
        kelompokFilter: '{{ request('kelompok', 'all') }}',
        showAddModal: false,
        showEditModal: false,
        editActionUrl: '',
        ...
        filterByKelompok(kelompokKode) {
            this.kelompokFilter = kelompokKode;
            let url = new URL(window.location.href);
            if (kelompokKode === 'all') {
                url.searchParams.delete('kelompok');
            } else {
                url.searchParams.set('kelompok', kelompokKode);
            }
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-5 shadow-xl mb-6">
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-wrap items-center gap-2 pt-1 text-xs">
                    ...
                    <button type="button" @click="filterByKelompok('all')"
                    ...
                    <button type="button" @click="filterByKelompok('5.2.01')"
                    ...
                    <button type="button" @click="filterByKelompok('5.2.02')"
                    ...
                    <button type="button" @click="filterByKelompok('5.2.03')"
                    ...
                    <button type="button" @click="filterByKelompok('5.2.04')"
                    ...
                    <button type="button" @click="filterByKelompok('5.2.05')"
                    ...
                    <button type="button" @click="filterByKelompok('5.2.06')"
                ...
                <!-- Search Bar & Counter -->
                <form method="GET" action="{{ route('master.rekening_belanja') }}" class="flex flex-col sm:flex-row items-center gap-3 w-full pt-2 border-t border-slate-800/80">
                    @if (request('kelompok') && request('kelompok') !== 'all')
                    ...
                    <div class="relative flex-1 w-full">
                        ...
                        @if (request('search'))
                            <a href="{{ route('master.rekening_belanja', array_filter(['kelompok' => request('kelompok')])) }}" class="absolute right-3.5 top-3 text-slate-500 hover:text-white text-xs font-bold">&times;</a>
                        @endif
                    </div>
