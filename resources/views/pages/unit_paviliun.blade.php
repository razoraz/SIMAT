    ...
    <div x-data="{
        ...
        units: [
            { 
                ...
                total_aset: 48, 
                total_nilai: 'Rp 4.250.000.000', 
                kapasitas: '24 Kamar VVIP', 
                pj_aset: 'Siti Aminah, A.Md.Kep',
                assets: [
                    { kode: '1.3.2.05.01.01.002', nama: 'Patient Monitor Bedside Multiparameter', category: 'KIB B', merk: 'Philips IntelliVue MX450', no_seri: 'SN-MX450-9921', tahun: '2025', kondisi: 'Baik', nilai: 145000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.04.01.02.001', nama: 'Electric Hospital Bed 3-Crank VVIP', category: 'KIB B', merk: 'Paramount Bed Qualitas Core', no_seri: 'PB-QC-0412', tahun: '2024', kondisi: 'Baik', nilai: 48000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.03.004', nama: 'Syringe Pump Digital High Precision', category: 'KIB B', merk: 'Terumo TE-SS700', no_seri: 'TRM-70019-GA', tahun: '2025', kondisi: 'Baik', nilai: 28500000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.03.005', nama: 'Infusion Pump Smart Peristaltic', category: 'KIB B', merk: 'B.Braun Infusomat Space', no_seri: 'BB-SP-8831', tahun: '2024', kondisi: 'Baik', nilai: 32000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.02.01.001', nama: 'Biphasic Defibrillator & AED Standby', category: 'KIB B', merk: 'Mindray BeneHeart D3', no_seri: 'MR-D3-2023', tahun: '2023', kondisi: 'Baik', nilai: 95000000, status: 'Standby Cadangan' },
                    { kode: '1.3.2.02.01.01.010', nama: 'AC Split Wall Inverter Heavy Duty 2 PK', category: 'KIB B', merk: 'Daikin Flash Inverter R32', no_seri: 'DK-FTKQ50-01', tahun: '2025', kondisi: 'Baik', nilai: 12500000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.08.01.01.003', nama: 'Smart TV LED UHD 50 Inch Kamar Pasien', category: 'KIB B', merk: 'Samsung Crystal 4K UHD', no_seri: 'SAM-50-UHD-09', tahun: '2024', kondisi: 'Baik', nilai: 8200000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.03.01.002', nama: 'Kulkas Penyimpan Vaksin & Obat Medis', category: 'KIB B', merk: 'Modena Medico 120L', no_seri: 'MDN-MED-12A', tahun: '2023', kondisi: 'Rusak Ringan', nilai: 18500000, status: 'Perlu Servis Kalibrasi' }
                ]
            },
            { 
                id: 2, 
                ...
                tipe: 'Pelayanan Kedaruratan Medis', 
                kepala: 'dr. Anita Wijaya, Sp.Em', 
                total_aset: 65, 
                total_nilai: 'Rp 2.850.000.000', 
                kapasitas: '30 Bed Resusitasi', 
                pj_aset: 'Ns. Hendra, S.Kep',
                assets: [
                    { kode: '1.3.2.05.01.02.001', nama: 'Emergency Transport ICU Ventilator', category: 'KIB B', merk: 'Hamilton-T1 Military Grade', no_seri: 'HML-T1-8839', tahun: '2025', kondisi: 'Baik', nilai: 385000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.04.002', nama: 'Point-of-Care Ultrasound (POCUS)', category: 'KIB B', merk: 'Mindray TE7 Touch Screen', no_seri: 'MR-TE7-1044', tahun: '2024', kondisi: 'Baik', nilai: 295000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.01.005', nama: '12-Channel Electrocardiograph (ECG)', category: 'KIB B', merk: 'Fukuda Denshi FX-8222', no_seri: 'FKD-8222-IGD', tahun: '2025', kondisi: 'Baik', nilai: 68000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.02.02.003', nama: 'Mobile Surgical Examination Light LED', category: 'KIB B', merk: 'Mindray HyLED 600M', no_seri: 'HYL-600M-01', tahun: '2024', kondisi: 'Baik', nilai: 54000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.03.008', nama: 'High-Vacuum Medical Suction Pump', category: 'KIB B', merk: 'Medela Vario 18 High-Flow', no_seri: 'MDL-V18-990', tahun: '2023', kondisi: 'Baik', nilai: 24500000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.04.01.01.002', nama: 'Hydraulic Ambulance Emergency Stretcher', category: 'KIB B', merk: 'Stryker Rugged M1 System', no_seri: 'STK-M1-4402', tahun: '2024', kondisi: 'Baik', nilai: 72000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.01.003', nama: 'Multiparameter Patient Monitor IGD', category: 'KIB B', merk: 'GE Healthcare B125', no_seri: 'GE-B125-901', tahun: '2025', kondisi: 'Baik', nilai: 85000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.04.02.01.001', nama: 'Crash Cart Emergency Resuscitation Trolley', category: 'KIB B', merk: 'Apex Meditech Complete Kit', no_seri: 'APX-CC-09B', tahun: '2024', kondisi: 'Baik', nilai: 19500000, status: 'Standby Cadangan' }
                ]
            },
            { 
                id: 3, 
                kode: 'UNIT-003', 
                nama: 'Instalasi Radiologi & Imaging', 
                tipe: 'Penunjang Diagnostik Medis', 
                kepala: 'dr. Bambang Soedibyo, Sp.Rad', 
                total_aset: 28, 
                total_nilai: 'Rp 6.120.000.000', 
                kapasitas: '4 Ruang Pemeriksaan', 
                pj_aset: 'Wahyu Hidayat, A.Md.Rad',
                assets: [
                    { kode: '1.3.2.05.02.01.005', nama: 'CT-Scan 128 Slice High Resolution System', category: 'KIB B', merk: 'Siemens SOMATOM Perspective', no_seri: 'SOM-128-RAD01', tahun: '2024', kondisi: 'Baik', nilai: 4250000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.02.01.002', nama: 'Digital Stationary X-Ray System 500mA', category: 'KIB B', merk: 'Shimadzu RADspeed Fit', no_seri: 'SHM-RAD-500F', tahun: '2023', kondisi: 'Baik', nilai: 980000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.04.001', nama: 'USG 4D Obstetric, Vascular & Cardiology', category: 'KIB B', merk: 'GE Healthcare Voluson E10', no_seri: 'GE-VOL-E10-99', tahun: '2025', kondisi: 'Baik', nilai: 650000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.02.03.001', nama: 'Computed Radiography (CR) Digitizer', category: 'KIB B', merk: 'Agfa CR 30-X Digitizer', no_seri: 'AGFA-CR30-02', tahun: '2023', kondisi: 'Baik', nilai: 180000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.08.02.01.004', nama: 'Diagnostic Medical Display Dual Monitor 3MP', category: 'KIB B', merk: 'Eizo RadiForce RX360', no_seri: 'EIZ-RX360-RAD', tahun: '2024', kondisi: 'Baik', nilai: 55000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.02.04.002', nama: 'Lead Apron Shielding Radiation Mobile Rack', category: 'KIB B', merk: 'Infab Protection 0.5mmPb', no_seri: 'INF-RAD-6P', tahun: '2025', kondisi: 'Baik', nilai: 25000000, status: 'Aktif Digunakan' }
                ]
            },
            { 
                id: 4, 
                ...
                tipe: 'Operasi & Bedah Medis', 
                kepala: 'dr. Fajar Santoso, Sp.B', 
                total_aset: 52, 
                total_nilai: 'Rp 5.400.000.000', 
                kapasitas: '6 Kamar Operasi', 
                pj_aset: 'Ns. Ratna Dewi, S.Kep',
                assets: [
                    { kode: '1.3.2.05.01.02.003', nama: 'Workstation Mesin Anestesi Digital', category: 'KIB B', merk: 'Dräger Fabius Plus XL', no_seri: 'DRG-FAB-9901', tahun: '2024', kondisi: 'Baik', nilai: 580000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.04.01.03.001', nama: 'Electro-Hydraulic Operating Table Bed', category: 'KIB B', merk: 'Berchtold Operon D850', no_seri: 'BRT-OP-850-01', tahun: '2024', kondisi: 'Baik', nilai: 420000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.02.01.004', nama: 'C-Arm Mobile Fluoroscopy System X-Ray', category: 'KIB B', merk: 'Siemens Cios Select X-Ray', no_seri: 'SMN-CIOS-02A', tahun: '2023', kondisi: 'Baik', nilai: 1150000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.02.02.001', nama: 'Electrosurgical Unit (ESU) & Vessel Sealer', category: 'KIB B', merk: 'Covidien Valleylab FT10', no_seri: 'VLB-FT10-770', tahun: '2025', kondisi: 'Baik', nilai: 310000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.02.02.004', nama: 'Dual-Arm Surgical Shadowless Lamp LED', category: 'KIB B', merk: 'Maquet PowerLED 500/300', no_seri: 'MQT-PL500-02', tahun: '2024', kondisi: 'Baik', nilai: 240000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.03.02.001', nama: 'Autoclave Steam Sterilizer CSSD 300 Liter', category: 'KIB B', merk: 'Getinge HS66 Turbo Pro', no_seri: 'GTG-HS66-10B', tahun: '2023', kondisi: 'Baik', nilai: 490000000, status: 'Aktif Digunakan' }
                ]
            },
            { 
                id: 5, 
                kode: 'UNIT-005', 
                nama: 'Instalasi Rawat Intensif (ICU)', 
                tipe: 'Perawatan Intensif Kritis', 
                kepala: 'dr. Maya Kusuma, Sp.An-TI', 
                total_aset: 42, 
                total_nilai: 'Rp 3.900.000.000', 
                kapasitas: '12 Bed Terisolasi', 
                pj_aset: 'Ns. Aditya, S.Kep',
                assets: [
                    { kode: '1.3.2.05.01.02.002', nama: 'Advanced Critical Care ICU Ventilator', category: 'KIB B', merk: 'Puritan Bennett 980 Plus', no_seri: 'PB-980-6610', tahun: '2025', kondisi: 'Baik', nilai: 495000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.01.001', nama: 'Central Patient Monitoring Station Server', category: 'KIB B', merk: 'Nihon Kohden Life Scope G9', no_seri: 'NK-LS-G9-01', tahun: '2024', kondisi: 'Baik', nilai: 320000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.03.001', nama: 'Modular Syringe & Infusion Docking Station', category: 'KIB B', merk: 'B.Braun Space Station 6-Slot', no_seri: 'BB-SS-06-ICU', tahun: '2024', kondisi: 'Baik', nilai: 140000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.05.001', nama: 'Continuous Renal Replacement Therapy (CRRT)', category: 'KIB B', merk: 'Baxter Prismaflex System', no_seri: 'BXT-PF-2023A', tahun: '2023', kondisi: 'Baik', nilai: 460000000, status: 'Standby Cadangan' },
                    { kode: '1.3.2.05.01.06.002', nama: 'Hyper-Hypothermia Patient Blanketrol System', category: 'KIB B', merk: 'Gentherm Blanketrol III', no_seri: 'BNT-III-440', tahun: '2024', kondisi: 'Baik', nilai: 115000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.01.07.001', nama: 'Mobile Bronchoscopy Video Tower System', category: 'KIB B', merk: 'Olympus BF-H190 Video Scope', no_seri: 'OLY-BF-190-01', tahun: '2024', kondisi: 'Baik', nilai: 380000000, status: 'Aktif Digunakan' }
                ]
            },
            { 
                id: 6, 
                kode: 'UNIT-006', 
                nama: 'Instalasi Laboratorium Patologi', 
                tipe: 'Penunjang Diagnostik Lab', 
                kepala: 'dr. Yuniar Rahma, Sp.PK', 
                total_aset: 38, 
                total_nilai: 'Rp 1.950.000.000', 
                kapasitas: '5 Ruang Analisa Lab', 
                pj_aset: 'Diana Putri, A.Md.AK',
                assets: [
                    { kode: '1.3.2.05.03.03.001', nama: 'Automated Clinical Chemistry Analyzer', category: 'KIB B', merk: 'Sysmex BX-4000 System', no_seri: 'SYX-BX-4000-01', tahun: '2024', kondisi: 'Baik', nilai: 680000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.03.03.002', nama: 'Automated Hematology 5-Part Diff Analyzer', category: 'KIB B', merk: 'Mindray BC-6800 Plus', no_seri: 'MR-BC6800-09', tahun: '2025', kondisi: 'Baik', nilai: 390000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.03.04.001', nama: 'Refrigerated High-Speed Centrifuge Pro', category: 'KIB B', merk: 'Eppendorf 5810R Pro', no_seri: 'EPP-5810R-LAB', tahun: '2024', kondisi: 'Baik', nilai: 145000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.03.05.001', nama: 'Biosafety Cabinet (BSC) Class II Type A2', category: 'KIB B', merk: 'Esco Airstream AC2-4E8', no_seri: 'ESC-AC2-4E-02', tahun: '2023', kondisi: 'Baik', nilai: 88000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.03.06.001', nama: 'Clinical Laboratory Binocular Microscope LED', category: 'KIB B', merk: 'Olympus CX23 System', no_seri: 'OLY-CX23-11A', tahun: '2025', kondisi: 'Baik', nilai: 24000000, status: 'Aktif Digunakan' },
                    { kode: '1.3.2.05.03.01.001', nama: 'Blood Bank Refrigerator +4°C Certified', category: 'KIB B', merk: 'Helmer Scientific iBR120', no_seri: 'HLM-IBR-120-01', tahun: '2024', kondisi: 'Baik', nilai: 120000000, status: 'Aktif Digunakan' }
                ]
            }
        ],
            ...
            <div @click.away="showDetailModal = false" class="bg-slate-900 border border-slate-800 rounded-3xl max-w-5xl w-full p-6 sm:p-7 shadow-2xl space-y-5 my-auto max-h-[90vh] flex flex-col">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 shrink-0" x-if="selectedUnit">
                    <div class="p-3 bg-slate-950/70 rounded-2xl border border-slate-800/80">
                        <span class="text-[10px] uppercase font-bold text-slate-400 block tracking-wider">Kepala Ruangan</span>
                        <p class="font-bold text-white text-xs mt-0.5" x-text="selectedUnit.kepala"></p>
                    </div>
                    <div class="p-3 bg-slate-950/70 rounded-2xl border border-slate-800/80">
                        <span class="text-[10px] uppercase font-bold text-blue-400 block tracking-wider">PJ Aset Sub-Admin</span>
                        <p class="font-bold text-blue-300 text-xs mt-0.5" x-text="selectedUnit.pj_aset"></p>
                    </div>
                    <div class="p-3 bg-slate-950/70 rounded-2xl border border-slate-800/80">
                        <span class="text-[10px] uppercase font-bold text-cyan-400 block tracking-wider">Total Aset Terpasang</span>
                        <p class="font-black text-cyan-300 text-xs mt-0.5" x-text="selectedUnit.total_aset + ' Item Inventaris'"></p>
                    </div>
                    <div class="p-3 bg-slate-950/70 rounded-2xl border border-slate-800/80">
