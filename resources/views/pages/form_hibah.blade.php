            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-0.5">
                        Pendaftaran aset perolehan hibah / bantuan dari pihak ketiga tanpa pagu belanja modal APBD &amp; tanpa rekanan tender.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-5 shadow-xl">
            <div class="grid grid-cols-3 gap-3 sm:gap-4">
                ...
                <button type="button" @click="goToStep(3)" class="text-left group cursor-pointer p-2 sm:p-0 rounded-xl hover:bg-slate-800/40 transition-all">
                    <div class="flex items-center space-x-2 sm:space-x-3 mb-1.5 sm:mb-2">
                        <div class="w-8 h-8 rounded-xl font-bold text-xs flex items-center justify-center transition-all shrink-0"
                             :class="step === 3 ? 'bg-amber-400 text-slate-950 shadow-lg shadow-amber-400/30' : 'bg-slate-950 text-slate-500 border border-slate-800'">
                            <span>3</span>
                        </div>
                        <div class="min-w-0">
        ...
        <form @submit.prevent="submitForm" class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
            ...
            <div x-show="step === 1" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6">
                ...
                <div class="border-b border-slate-800 pb-4">
                    ...
                    <p class="text-xs text-slate-400 mt-0.5">
                        Masukkan legalitas penyerahan (BAST Hibah), periode pembukuan, dan pihak pemberi hibah (tanpa pagu belanja &amp; tanpa rekanan).
                    </p>
                </div>
                ...
                <div class="p-5 rounded-2xl bg-slate-950/70 border border-amber-400/30 space-y-4 shadow-xl">
                    ...
                    <!-- Nilai Taksiran Buku Hibah (Opsional / Bisa Rp 0) -->
                    <div>
                        <label class="block text-xs font-bold text-slate-200 mb-1.5 flex items-center justify-between">
                            <span>Nilai Taksiran / Buku Hibah (Rp) <span class="text-slate-400 font-normal text-[11px]">(Boleh Rp 0 jika tanpa taksiran)</span></span>
            ...
            <!-- ========================================================================= -->
            <!-- LANGKAH 3: RINCIAN SPESIFIKASI TEKNIS KIB & PENEMPATAN RUANGAN             -->
            <!-- ========================================================================= -->
            <div x-show="step === 3" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6">
                ...
                <div class="border-b border-slate-800 pb-4">
                    <div class="inline-flex items-center space-x-2 px-3 py-1 rounded-full text-xs font-bold mb-2"
                        ...
                        <span>Langkah 3 dari 3 (Terakhir)</span>
                    </div>
                    <h2 class="text-lg font-bold text-white flex items-center space-x-2">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-2xl bg-emerald-950/30 border border-emerald-500/40 shadow-md">
                            <div class="space-y-0.5">
                                ...
                                <p class="text-[11px] text-slate-400">
                                    Total Luas: <strong class="text-cyan-300" x-text="totalLuasTanah.toLocaleString('id-ID') + ' m²'"></strong> • Setiap bidang tanah memiliki sertifikat, luas, dan alamat lokasi fisik masing-masing.
                                </p>
                            </div>
                ...
                <!-- --------------------------------------------------------------------- -->
                <!-- KONDISI C: FORM GEDUNG, JARINGAN, LAINNYA, ATB, KDP                   -->
                <!-- --------------------------------------------------------------------- -->
                ...
                <!-- --------------------------------------------------------------------- -->
                <div class="p-5 rounded-2xl bg-slate-950/80 border border-amber-400/30 space-y-4 shadow-xl">
                    <span class="text-xs font-extrabold text-amber-400 uppercase tracking-wider block">
                        🏢 Pejabat Penerima &amp; Lokasi Penempatan Aset di RSUD:
                    </span>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea x-model="formData.hibah_keterangan" rows="2"
                                placeholder="Contoh: Hibah sarana medis dari Kemenkes RI, kondisi operasional aktif..."
                ...
                <div class="p-5 rounded-2xl bg-slate-950 border border-emerald-500/30 space-y-3 shadow-xl">
                    ...
                    <template x-if="isTanah && formData.tanah_items.length > 0">
                        <div class="p-3 rounded-xl bg-slate-900 border border-emerald-500/20 text-xs space-y-1">
                            <span class="text-[10px] font-bold text-emerald-400 uppercase tracking-wider block">Rincian Tanah:</span>
        ...
        function formHibah() {
            return {
                ...
                formData: {
                    ...
                    // Spesifikasi Jalan & Jaringan (KIB D)
                    jaringan_panjang_m: '',
                    jaringan_lebar_m: '',
                    jaringan_luas_m2: '',
