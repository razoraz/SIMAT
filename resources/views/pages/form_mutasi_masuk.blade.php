        ...
        <form @submit.prevent="submitForm" class="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
            ...
            <div x-show="step === 1" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6">
                ...
                <div class="p-5 rounded-2xl bg-slate-950/70 border border-purple-500/30 space-y-4 shadow-xl">
                    ...
                    <!-- Nilai Buku / Taksiran Aset Mutasi Masuk (Rp) -->
                    <div>
            ...
            <div x-show="step === 3" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6">
                ...
                <div class="border-b border-slate-800 pb-4">
                    <div class="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-300 border border-emerald-500/20 text-xs font-bold mb-2">
                        <span>Langkah 3 dari 3</span>
                    </div>
                    <h2 class="text-lg font-bold text-white flex items-center space-x-2">
                        <span x-text="kibBadgeIcon"></span>
                        <span x-text="'Spesifikasi Teknis (' + kibLabel + ') & Penempatan Baru di RSUD'"></span>
                    </h2>
                    <p class="text-xs text-slate-400 mt-0.5">
                        <span x-show="isTanah">Lengkapi data sertifikat, luas, dan batas bidang tanah pelimpahan (multi-bidang didukung).</span>
                        <span x-show="!isTanah">Lengkapi spesifikasi teknis barang pelimpahan, lalu tentukan unit ruangan penempatan baru di RSUD Dr. H. Koesnandi.</span>
                    </p>
                </div>
                ...
                <div class="p-5 rounded-2xl bg-slate-950 border border-purple-500/30 space-y-3 shadow-xl">
                    <div class="flex items-center justify-between border-b border-slate-800 pb-2">
                        <span class="text-xs font-extrabold text-purple-400 uppercase tracking-wider flex items-center gap-2">
                            <span>📋 Ringkasan Pendaftaran Mutasi Masuk</span>
                        </span>
