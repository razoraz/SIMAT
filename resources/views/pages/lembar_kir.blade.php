<x-layout title="Lembar Kartu Inventaris Ruangan (KIR) - SIMAT-RK">
    ...
    @include('pages.lembar_kir_partials.scripts')

    <div x-data="kirRuanganData()" x-cloak class="space-y-6">
        @include('pages.lembar_kir_partials.toast_notification')
        @include('pages.lembar_kir_partials.header_kpi')
        @include('pages.lembar_kir_partials.table_assets')

        {{-- Modals & Dialogs --}}
        @include('pages.lembar_kir_partials.modal_edit_kondisi')
        @include('pages.lembar_kir_partials.modal_print_kir')
        @include('pages.lembar_kir_partials.modal_detail')
    </div>

    @include('pages.lembar_kir_partials.print_styles')
</x-layout>
