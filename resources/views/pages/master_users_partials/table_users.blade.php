                                    ...
                                    <div class="flex items-center justify-center gap-1.5">
                                        ...
                                        <template x-if="!canEditUser(item)">
                                            <button type="button" disabled :title="getEditTooltip(item)"
                                                class="px-2.5 py-1.5 rounded-xl bg-slate-800/40 text-slate-500 border border-slate-800 font-semibold text-xs inline-flex items-center space-x-1 opacity-50 cursor-not-allowed">
                                        ...
                                        <template x-if="!canDeleteUser(item)">
                                            <button type="button" disabled :title="getDeleteTooltip(item)"
                                                class="px-2.5 py-1.5 rounded-xl bg-slate-800/40 text-slate-500 border border-slate-800 font-semibold text-xs inline-flex items-center space-x-1 opacity-40 cursor-not-allowed">
