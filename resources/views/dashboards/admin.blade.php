    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 shadow-xl">
            ...
            <div class="flex items-baseline justify-between">
                <p class="text-2xl font-black text-white">1,380 <span class="text-xs font-bold text-emerald-400">Baik</span></p>
                <span class="text-xs font-extrabold text-rose-400 bg-rose-500/10 px-2 py-0.5 rounded-md border border-rose-500/20">48 Rusak</span>
            </div>
